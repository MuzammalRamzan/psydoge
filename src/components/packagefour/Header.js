...
import logo from '../../assets/rex-bet-text-logo.png'
    ...
    // <div className="container">
      <div className="flex flex-row justify-between h-18 py-4 bg-header none px-6 md:px-10 lg:px-14">
        ...
        <div className="flex flex-row justify-center items-center">
          {/* <button className="bg-main-color4 px-3 rounded"> {account} */}
          {/* BTCB Miners  */}
          {/* </button> */}

          <a href={srclink} target="_blank" className="bg-main-color4 px-3 py-2 rounded m-2">BTCB Miners</a>

          {/* <button type="button" class="btn btn-light">Light</button> */}
          <button className="bg-main-color4 px-3 py-2 rounded">{account}</button>

          {/* <button className="bg-main-color4 px-3 rounded">waqas</button> */}
        </div>
      </div >
    // </div >
  )
