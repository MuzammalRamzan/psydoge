                ...
                <div className="flex flex-row flex-wrap justify-center lg:justify-start md:justify-start sm-justify-start mt-10">
                    {
                        cards && cards.map((item, index) => {
                            return (item === "1") ? <img src={One} alt="img1" className="mr-4 mb-4 cursor-pointer" key={index} id={index} onClick={handleCard} /> :
                                (item === "2") ? <img src={Two} alt="img2" className="mr-4 mb-4 cursor-pointer" key={index} id={index} onClick={handleCard} /> :
                                    (item === "3") ? <img src={Three} alt="img3" className="mr-4 mb-4 cursor-pointer" key={index} id={index} onClick={handleCard} /> :
                                        (item === "4") ? <img src={Four} alt="img3" className="mr-4 mb-4 cursor-pointer" key={index} id={index} onClick={handleCard} /> :
                                            (item === "5") ? <img src={Five} alt="img5" className="mr-4 mb-4 cursor-pointer" key={index} id={index} onClick={handleCard} /> :
                                                (item === "6") ? <img src={Six} alt="img6" className="mr-4 mb-4 cursor-pointer" key={index} id={index} onClick={handleCard} /> :
                                                    null;
                        }
                        )
                    }
                </div>
                <p className="text-xl text-pure-white font-semibold mt-20">If you bet 100 PSYD token (min bet 10, max bet 2000)</p>
                    ...
                    <table className=" text-white rounded-t-lg mt-4">
                        ...
                        <tbody>
                            ...
                            <tr className="bg-tcolor text-left text-sm md:text-base">
                                ...
                                <td className="px-3 xsm:px-2 sm:px-6  border-r border-black">{cardSix * 100 - 100}</td>
                        ...
                        (<div className=" mt-6 lg:mt-28 md:mt-18 sm:mt-12 bg-dt-gr py-8 lg:py-12 md:py-10 sm:py-9 px-8 lg:px-12 md:px-10 sm:px-9">
                            ...
                            <ul className="list-inside flex flex-col flex-wrap my-12">
                                ...
                                <div className="flex flex-row items-start mb-1 lg:items-center md:items-center sm:items-start">
                                    ...
                                    <li className="text-pure-white text-base sm:text-lg md:text-xl lg:text-xl" key="7">Min Bet is 100 PSYD Token, Max Bet is 1,000 PSYD Token</li>
                                </div>
                            </ul>
                        </div>
                        )
