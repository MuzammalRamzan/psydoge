...
import { contractAddress5, abi5, tokenAddress5, tokenAbi5 } from '../../utils/constant'
...
function Hero() {
    ...
    const balanceOf = async () => {
        ...
        try {
            let accounts = await getAccounts();
            accountAd = accounts[0];
            let tokenContract = new web3.eth.Contract(tokenAbi5, tokenAddress5);
    ...
    const handleClick = async () => {
        ...
        try {
            console.log(account)
            let contract = new web3.eth.Contract(abi5, contractAddress5);
            let tokenContract = new web3.eth.Contract(tokenAbi5, tokenAddress5);
            if (value >= 10 && value <= 2000) {
                await tokenContract.methods.approve(contractAddress5, web3.utils.toWei(value)).send({ from: account })
                    .then(async (output) => {
    ...
    return (
        <div className="lg:bg-hero-background bg-gradient-to-b from-primary to-secondary bg-no-repeat bg-contain bg-top h-1/5 none px-6 md:px-10 lg:px-14 flex flex-col xl:flex-row lg:flex-col md:flex-col sm:flex-col justify-around packagefive">
            <div className="py-12 xl:py-10 2xl:w-7/12 xl:w-6/12">
                ...
                <ul className="list-inside flex flex-col flex-wrap my-16">
                    <div className="flex flex-row items-start mb-2 lg:items-center md:items-center sm:items-center">
                        ...
                        <li className="text-pure-white text-base sm:text-lg md:text-xl lg:text-xl" key="1">You can earn ADA  token reward with challenge !</li>
                    </div>
                    <div className="flex flex-row items-start mb-2 lg:items-center md:items-center sm:items-center">
                        <img src={disc} alt='icon' className="w-4 h-4 mr-4 p-0.5" />
                            ...
                            return (item === "0") ? <img src={One} alt="img1" className="mr-4 mb-4 cursor-pointer" key={index} id={index} onClick={handleCard} /> :
                                (item === "1") ? <img src={Two} alt="img2" className="mr-4 mb-4 cursor-pointer" key={index} id={index} onClick={handleCard} /> :
                                    (item === "2") ? <img src={Three} alt="img3" className="mr-4 mb-4 cursor-pointer" key={index} id={index} onClick={handleCard} /> :
                                        (item === "3") ? <img src={Four} alt="img4" className="mr-4 mb-4 cursor-pointer" key={index} id={index} onClick={handleCard} /> :
                ...
                <p className="text-xl text-pure-white font-semibold mt-20">If you bet 100 ADA token (min bet 10, max bet 2000)</p>
                        ...
                        (<div className=" mt-6 lg:mt-28 md:mt-18 sm:mt-12 bg-dt-gr py-8 lg:py-12 md:py-10 sm:py-9 px-8 lg:px-12 md:px-10 sm:px-9">
                            ...
                            <ul className="list-inside flex flex-col flex-wrap my-12">
                                ...
                                <div className="flex flex-row items-start mb-1 lg:items-center md:items-center sm:items-start">
                                    ...
                                    <li className="text-pure-white text-base sm:text-lg md:text-xl lg:text-xl" key="7">Min Bet is 100 ADA Token, Max Bet is 1,000 ADA Token</li>
                                </div>
                            </ul>
                        </div>
                        )
                                ...
                                <div className="mt-4 overflow-auto h-56">
                                    {
                                        cardList && cardList?.map((item, index) => {
                                            return (item[0] === "0") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={One} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} ADA</p></div></div> :
                                                (item[0] === "1") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={Two} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} ADA</p></div></div> :
                                                    (item[0] === "2") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={Three} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} ADA</p></div></div> :
                                                        (item[0] === "3") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={Four} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} ADA</p></div></div> :
                                                            (item[0] === "4") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={Five} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} ADA</p></div></div> :
                                                                (item[0] === "5") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={Six} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} ADA</p></div></div> :
                                                                    null;
                                        })
                                    }
                                </div>
                        ...
                        comp ?
                            <>
                                <div className="flex flex-row items-center justify-between mb-4">
                                    ...
                                    <span className="sm:text-xl xsm:text-md text-white font-semibold">{mybalance} ADA</span>
                                </div>
                                ...
                                <div className="flex flex-row items-center justify-between py-4">
                                    ...
                                    <div>
                                        ...
                                        <span className="sm:text-xl xsm:text-lg text-white font-semibold">ADA</span>
                                    </div>
                                </div>
                                <div className="mt-6">
                                    <p className="py-3 text-white">*Min bet 10 token, Max bet 2,000 token</p>
                                    <button className="bg-main-color px-3 rounded mt-10 w-full py-4 font-bold disabled:bg-header0 text-black" onClick={handleClick} disabled={buttonState}>{button}</button>
                                </div>
                            </>
                            :
                            compWithdraw ?
