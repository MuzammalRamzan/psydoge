...
import disc from '../../assets/list-item-3.png'
...
import handIcon from '../../assets/hand3.png'
import { contractAddress3, abi3, tokenAddress3, tokenAbi3 } from '../../utils/constant'
...
function Hero() {
    ...
    const balanceOf = async () => {
        ...
        try {
            let accounts = await getAccounts();
            accountAd = accounts[0];
            let tokenContract = new web3.eth.Contract(tokenAbi3, tokenAddress3);
    ...
    const handleClick = async () => {
        ...
        try {
            console.log(account)
            let contract = new web3.eth.Contract(abi3, contractAddress3);
            let tokenContract = new web3.eth.Contract(tokenAbi3, tokenAddress3);
            if (value >= 10 && value <= 2000) {
                await tokenContract.methods.approve(contractAddress3, web3.utils.toWei(value)).send({ from: account })
                    .then(async (output) => {
    ...
    return (
        <div className="lg:bg-hero-background bg-gradient-to-b from-primary to-secondary bg-no-repeat bg-contain bg-top h-1/5 none px-6 md:px-10 lg:px-14 flex flex-col xl:flex-row lg:flex-col md:flex-col sm:flex-col justify-around">
            <div className="py-12 xl:py-10 2xl:w-7/12 xl:w-6/12">
                ...
                <p className="text-xl text-pure-white font-semibold mt-20">If you bet 100 BSW token (min bet 10, max bet 2000)</p>
                <div className="flex flex-row align-center justify-center sm:flex-col">
                    <table className=" text-white rounded-t-lg mt-4">
                        <thead>
                            <tr className="bg-main-color3 text-left text-sm md:text-base">
            ...
            <div className="mb-0 xl:ml-10 2xl:ml-0">
                {
                    comp ?
                        (<div className=" mt-6 lg:mt-28 md:mt-18 sm:mt-12 bg-dt-gr py-8 lg:py-12 md:py-10 sm:py-9 px-8 lg:px-12 md:px-10 sm:px-9">
                            <h2 className="text-4xl text-main3 font-semibold">Game Rules</h2>
                        ...
                        compWithdraw ?
                            (<div className="h-auto w-12/12 mt-6 lg:mt-28 md:mt-18 sm:mt-12 bg-dt-gr py-2 lg:py-6 md:py-6 sm:py-4 px-2 lg:px-6 md:px-6 sm:px-4">
                                <h2 className="text-4xl text-main3 font-semibold">Checkout</h2>
                                <div className="py-4 px-4 bg-dark flex flex-row justify-between mt-4">
                                    <label className="text-main3 text-xl font-semibold">Item</label>
                                    <label className="text-main3 text-xl font-semibold">Quantity</label>
                                    <label className="text-main3 text-xl font-semibold">Bet amount</label>
                                </div>
                                <div className="mt-4 overflow-auto h-56">
                                    {
                                        cardList && cardList?.map((item, index) => {
                                            return (item[0] === "0") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={One} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} BSW</p></div></div> :
                                                (item[0] === "1") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={Two} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} BSW</p></div></div> :
                                                    (item[0] === "2") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={Three} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} BSW</p></div></div> :
                                                        (item[0] === "3") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={Four} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} BSW</p></div></div> :
                                                            (item[0] === "4") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={Five} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} BSW</p></div></div> :
                                                                (item[0] === "5") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={Six} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} BSW</p></div></div> :
                                                                    null;
                                        })
                                    }
                                </div>
                            ...
                            checkOut ?
                                ...
                                (
                                    <div className=" mt-6 lg:mt-28 md:mt-18 sm:mt-12 bg-dt-gr py-8 lg:py-12 md:py-10 sm:py-9 px-8 lg:px-12 md:px-10 sm:px-9 flex flex-col justify-center items-center">
                                        <h2 className="text-xl msm:text-4xl sm:text-4xl text-main3 font-semibold text-start">CONGRATULATIONS</h2>
                        ...
                        comp ?
                            <>
                                <div className="flex flex-row items-center justify-between mb-4">
                                    <h3 className="sm:text-2xl xsm:text-lg text-main3 font-semibold">My Wallet</h3>
                                ...
                                <div className="flex flex-row items-center justify-between py-4">
                                    <h3 className="sm:text-2xl xsm:text-lg text-main3 font-semibold">Bet Amount</h3>
                                    <div>
                                ...
                                <div className="mt-6">
                                    ...
                                    <button className="bg-main-color3 px-3 rounded mt-10 w-full py-4 font-bold disabled:bg-header0" onClick={handleClick} disabled={buttonState}>{button}</button>
                                </div>
                            </>
                            :
                            compWithdraw ?
                                ...
                                <div className="mt-6 flex flex-col">
                                    ...
                                    <div className="flex flex-row justify-between">
                                        <h3 className="sm:text-2xl xsm:text-lg md:text-lg text-main3 font-semibold my-4">Total</h3>
                                        <h3 className="sm:text-2xl xsm:text-lg md:text-lg text-white font-semibold my-4">{total}</h3>
                                    </div>
                                    <hr />
                                    <button className="bg-main-color3 px-3 rounded mt-10 w-full py-4 font-bold disabled:bg-header0" onClick={handleCheckout}>{withDrawButton}</button>
                                </div>
                                :
                                checkOut ?
                                    <div className="mt-6 flex flex-col">
                                        <p className="py-3 text-white text-center">Click withdraw button to send token to your wallet</p>
                                        <button className="bg-main-color3 px-3 rounded mt-10 w-full py-4 font-bold disabled:bg-header0" onClick={handleWithdraw} disabled={buttonState}>{withDraw}</button>
                                    </div>
                                    :
                                    <div className="mt-6 flex flex-col">
                                        <button className="bg-main-color3 px-3 rounded mt-10 w-full py-4 font-bold disabled:bg-header0" onClick={handleCongrats} disabled={buttonState}>{withDraw}</button>
                                    </div>
                    }
                </div>
            </div>
