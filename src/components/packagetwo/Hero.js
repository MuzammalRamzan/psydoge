...
import disc from '../../assets/list-item2.png'
...
import handIcon from '../../assets/hand2.png'
import { contractAddress2, abi2, tokenAddress2, tokenAbi2 } from '../../utils/constant'
...
function Hero() {
    ...
    const balanceOf = async () => {
        ...
        try {
            let accounts = await getAccounts();
            accountAd = accounts[0];
            let tokenContract = new web3.eth.Contract(tokenAbi2, tokenAddress2);
    ...
    const handleClick = async () => {
        ...
        try {
            console.log(account)
            let contract = new web3.eth.Contract(abi2, contractAddress2);
            let tokenContract = new web3.eth.Contract(tokenAbi2, tokenAddress2);
            if (value >= 10 && value <= 2000) {
                await tokenContract.methods.approve(contractAddress2, web3.utils.toWei(value)).send({ from: account })
                    .then(async (output) => {
    ...
    return (
        <div className="lg:bg-hero-background bg-gradient-to-b from-primary to-secondary bg-no-repeat bg-contain bg-top h-1/5 none px-6 md:px-10 lg:px-14 flex flex-col xl:flex-row lg:flex-col md:flex-col sm:flex-col justify-around">
            <div className="py-12 xl:py-10 2xl:w-7/12 xl:w-6/12">
                <h1 className="text-4.5xl font-bold text-white ">Random Card Want?</h1>
                <ul className="list-inside flex flex-col flex-wrap my-16">
                    <div className="flex flex-row items-start mb-2 lg:items-center md:items-center sm:items-center">
                        ...
                        <li className="text-pure-white text-base sm:text-lg md:text-xl lg:text-xl" key="1">You can earn BSW  token reward with challenge !</li>
                    </div>
                    <div className="flex flex-row items-start mb-2 lg:items-center md:items-center sm:items-center">
                        <img src={disc} alt='icon' className="w-4 h-4 mr-4 p-0.5" />
                    ...
                    <div className="flex flex-row items-start mb-2 lg:items-center md:items-center sm:items-start">
                        ...
                        <li className="text-pure-white text-base sm:text-lg md:text-xl lg:text-xl" key="3">The pool amount of this game will be used to develop burning and special events. <strong className=" ">Good Luck!</strong></li>
                    </div>
                </ul>
                <div className="flex flex-row flex-wrap justify-center lg:justify-start md:justify-start sm-justify-start">
                    ...
                    <img src={Four} alt="img4" className="mr-4 mb-4 cursor-pointer" key="4" id="4" onClick={handleModal} />
                ...
                <p className="text-xl font-semibold mt-20 text-white ">If you bet 100 BSW token (min bet 10, max bet 2000)</p>
                <div className="flex flex-row align-center justify-center sm:flex-col">
                    <table className=" text-white rounded-t-lg mt-4">
                        <thead>
                            <tr className="bg-main-color2 text-left text-sm md:text-base">
            ...
            <div className="mb-0 xl:ml-10 2xl:ml-0">
                {
                    comp ?
                        (<div className=" mt-6 lg:mt-28 md:mt-18 sm:mt-12 bg-dt-gr py-8 lg:py-12 md:py-10 sm:py-9 px-8 lg:px-12 md:px-10 sm:px-9">
                            <h2 className="text-4xl font-semibold text-main2 ">Game Rules</h2>
                            <ul className="list-inside flex flex-col flex-wrap my-12">
                                ...
                                <div className="flex flex-row items-start mb-1 lg:items-center md:items-center sm:items-start">
                                    ...
                                    <li className="text-pure-white text-base sm:text-lg md:text-xl lg:text-xl" key="7">Min Bet is 100 BSW Token, Max Bet is 1,000 BSW Token</li>
                                </div>
                            </ul>
                        </div>
                        )
                        ...
                        compWithdraw ?
                            (<div className="h-auto w-12/12 mt-6 lg:mt-28 md:mt-18 sm:mt-12 bg-dt-gr py-2 lg:py-6 md:py-6 sm:py-4 px-2 lg:px-6 md:px-6 sm:px-4">
                                ...
                                <div className="py-4 px-4 bg-dark flex flex-row justify-between mt-4">
                                    <label className="  text-xl font-semibold">Item</label>
                                    <label className="  text-xl font-semibold">Quantity</label>
                                    <label className="  text-xl font-semibold">Bet amount</label>
                                </div>
                                <div className="mt-4 overflow-auto h-56">
                                    {
                                        cardList && cardList?.map((item, index) => {
                                            return (item[0] === "1") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={One} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} BSW</p></div></div> :
                                                (item[0] === "2") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={Two} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} BSW</p></div></div> :
                                                    (item[0] === "3") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={Three} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} BSW</p></div></div> :
                                                        (item[0] === "4") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={Four} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} BSW</p></div></div> :
                                                            (item[0] === "5") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={Five} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} BSW</p></div></div> :
                                                                (item[0] === "6") ? <div className="flex flex-row items-center justify-start sm:justify-start"><img src={Six} alt="img1" className="mr-4 mb-2 w-16 h-20" key={index} /><div className="ml-16 mr-24"><p className="text-white text-lg">1</p></div><div><p className="text-white text-lg mr-6"> {Web3.utils.fromWei(item[1])} BSW</p></div></div> :
                                                                    null;
                                        })
                                    }
                                </div>
                            ...
                            checkOut ?
                                ...
                                (
                                    <div className=" mt-6 lg:mt-28 md:mt-18 sm:mt-12 bg-dt-gr py-8 lg:py-12 md:py-10 sm:py-9 px-8 lg:px-12 md:px-10 sm:px-9 flex flex-col justify-center items-center">
                                        <h2 className="text-xl msm:text-4xl sm:text-4xl  text-main2 font-semibold text-start">CONGRATULATIONS</h2>
                        ...
                        comp ?
                            <>
                                <div className="flex flex-row items-center justify-between mb-4">
                                    <h3 className="sm:text-2xl xsm:text-lg text-main2  font-semibold">My Wallet</h3>
                                    <span className="sm:text-xl xsm:text-md text-white font-semibold">{mybalance} BSW</span>
                                </div>
                                ...
                                <div className="flex flex-row items-center justify-between py-4">
                                    <h3 className="sm:text-2xl xsm:text-lg  text-main2 font-semibold">Bet Amount</h3>
                                    <div>
                                        ...
                                        <span className="sm:text-xl xsm:text-lg text-white font-semibold">BSW</span>
                                    </div>
                                </div>
                                <div className="mt-6">
                                    <p className="py-3 text-white ">*Min bet 10 token, Max bet 2,000 token</p>
                                    <button className="bg-main-color2 px-3 rounded mt-10 w-full py-4 font-bold disabled:bg-header0" onClick={handleClick} disabled={buttonState}>{button}</button>
                                </div>
                            </>
                            :
                            compWithdraw ?
                                ...
                                <div className="mt-6 flex flex-col">
                                    ...
                                    <div className="flex flex-row justify-between">
                                        <h3 className="sm:text-2xl xsm:text-lg md:text-lg  text-main2 font-semibold my-4">Total</h3>
                                        <h3 className="sm:text-2xl xsm:text-lg md:text-lg text-white font-semibold my-4">{total}</h3>
                                    </div>
                                    <hr />
                                    <button className="bg-main-color2 px-3 rounded mt-10 w-full py-4 font-bold disabled:bg-header0" onClick={handleCheckout}>{withDrawButton}</button>
                                </div>
                                :
                                checkOut ?
                                    <div className="mt-6 flex flex-col">
                                        <p className="py-3 text-white text-center">Click withdraw button to send token to your wallet</p>
                                        <button className="bg-main-color2 px-3 rounded mt-10 w-full py-4 font-bold disabled:bg-header0" onClick={handleWithdraw} disabled={buttonState}>{withDraw}</button>
                                    </div>
                                    :
                                    <div className="mt-6 flex flex-col">
                                        <button className="bg-main-color2 px-3 rounded mt-10 w-full py-4 font-bold disabled:bg-header0" onClick={handleCongrats} disabled={buttonState}>{withDraw}</button>
                                    </div>
                    }
                </div>
            </div>
