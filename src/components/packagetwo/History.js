...
function History() {
    ...
    const getContractTransferEventsByUser = async () => {
        ...
        try {
            await contract.getPastEvents('BetAmount', {
                fromBlock: 12733903,
                toBlock: 12738903,
    ...
    return (
        ...
        <div className="flex flex-row justify-center pt-0 xsm:pt-10 sm:pt-12 mb-6 px-6 md:px-10 lg:px-14 bg-light">
            <div>
                ...
                <div className="xsm:w-72 sm:w-94 overflow-x-scroll">
                    <table className=" text-white rounded-t-lg mt-4">
                        <thead>
                            <tr className="bg-header text-left text-sm md:text-base bg-light">
